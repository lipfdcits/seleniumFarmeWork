...
public class ShangPinChuKu {
    //商品出库
    public static By shangpinchuku=By.xpath("//*[@id=\"app\"]/div/div[2]/div[2]/div/div/div[1]");
    //新增出库
    public static By xinzengchuku=By.xpath("//*[@id=\"app\"]/div/div[2]/div[2]/div/div/div[3]/div[2]");
    //新增出库(标题)
    public static By xinzengchukuTitle=By.xpath("//*[@id=\"app\"]/div/div[2]/div[2]/div/div[1]/div[1]");
    //添加商品
